  ...
  public SalesPersonSelection(JFrame currentFrame, Dealer dealer) {
    ...
    list.addListSelectionListener(new ListSelectionListener() {
      public void valueChanged(ListSelectionEvent e) {
        ...
        {
          emDAO.getEM().refresh(list.getSelectedValue());
    ...
    btnDelete.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
    	  SalesPerson salesPerson = (SalesPerson) list.getSelectedValue();
    	  if (salesPerson.isOkToRemove())
    	  {
	    	  EntityTransaction userTransaction = emDAO.getEM().getTransaction();
	    	  userTransaction.begin();
	    	  dealer.removeSalesPerson(salesPerson);
